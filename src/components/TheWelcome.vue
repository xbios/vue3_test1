...
import Yeni1 from "./icons/IconYeni1.vue";
</script>
...
<template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Contribute to Vue Docs (3min)</template>
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi vel sequi hic, tenetur minus, dignissimos officia, obcaecati voluptatum cum quaerat vitae! Possimus, inventore
    tempora similique alias error ipsum veniam saepe?
  </WelcomeItem>
</template>
